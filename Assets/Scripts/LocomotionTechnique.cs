...
public class LocomotionTechnique : MonoBehaviour
{
    ...
    [Header("VR COMFORT - FADE TO BLACK")]
    ...
    [SerializeField] private float teleportFadeDelay = 0.02f;
    ...
    private IEnumerator TeleportWithFade()
    {
        ...
        yield return new WaitForSeconds(fadeOutTime + teleportFadeDelay);
