...
public class ParkourCounter : MonoBehaviour
{
    ...
    private int part1Count; // 6
    private int part2Count; // 11
    private int part3Count; // 13
    ...
    void Update()
    {
        if (isStageChange)
        {
            ...
            else if (locomotionTech.stage == firstBanner.name)
            {
                ...
                UpdateRecordText(1, part1Time, part1Count, 6);
            }
            else if (locomotionTech.stage == secondBanner.name)
            {
                ...
                UpdateRecordText(2, part2Time, part2Count, 11);
            }
            else if (locomotionTech.stage == finalBanner.name)
            {
                ...
                UpdateRecordText(3, part3Time, part3Count, 13);
                ...
                endTextGO.GetComponent<TMP_Text>().text = "Parkour Finished!\n" + recordText.text +
                    "\ntotal: " + timeCounter.ToString("F1") + ", " + coinCount.ToString() + "/30";
